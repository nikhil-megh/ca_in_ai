...
# output_excel_path = "/Users/nikhil/Documents/Thesis/FCT/Results/PCT_National/single_factor_abundance.xlsx"
...
output_excel_path = "/Users/nikhil/Documents/Thesis/FCT_EU_aggregated/Results/PCT_National/single_factor_abundance.xlsx"
...
if __name__ == "__main__":
    ...
    with pd.ExcelWriter(output_excel_path, engine="openpyxl") as writer:
        ...
        for year in range(2010, 2022):
            ...
            ai_prod = df_prod.loc["pct_national_ai_patents"]
            non_ai_prod = df_prod.loc["pct_national_non_ai_patents"]

            ai_measured_fct = df_measured_fct.loc["pct_national_ai_patents"]
            non_ai_measured_fct = df_measured_fct.loc["pct_national_non_ai_patents"]
            ...
            AI_prod_factor = df_prod.loc["pct_national_ai_patents"]
