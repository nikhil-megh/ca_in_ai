...
# output_excel_path = "/Users/nikhil/Documents/Thesis/FCT/Results/PCT_All/relative_factor_abundance.xlsx"
# TARGET = ["US", "CN", "JP", "KR", "DE", "FR", "NL", "SE", "FI", "GB"]
...
output_excel_path = "/Users/nikhil/Documents/Thesis/FCT_EU_aggregated/Results/PCT_All/relative_factor_abundance.xlsx"
...
if __name__ == "__main__":
    ...
    with pd.ExcelWriter(output_excel_path, engine="openpyxl") as writer:
        ...
        for year in range(2010, 2022):
            ...
            ai_prod = df_prod.loc["pct_all_ai_patents", countries]
            non_ai_prod = df_prod.loc["pct_all_non_ai_patents", countries]

            ai_measured_fct = df_measured_fct.loc["pct_all_ai_patents", countries]
            non_ai_measured_fct = df_measured_fct.loc["pct_all_non_ai_patents", countries]
