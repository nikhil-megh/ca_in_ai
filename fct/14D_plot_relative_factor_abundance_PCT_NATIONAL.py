...
# INPUT_EXCEL_PATH = "/Users/nikhil/Documents/Thesis/FCT/Results/PCT_National/eu_relative_factor_abundance.xlsx"
# OUTPUT_DIR = "/Users/nikhil/Documents/Thesis/FCT/Results/PCT_National"

INPUT_EXCEL_PATH = "/Users/nikhil/Documents/Thesis/FCT_EU_aggregated/Results/PCT_National/rfa_robustness_15.xlsx"
...
def plot_leamer_factor_abundance(df, output_dir):
    ...
    plt.title("Leamer Relative AI By Non-AI Factor Abundance inside the EU (2010–2021)")
    plt.xlabel("Year")
    ...
    output_path = os.path.join(output_dir, "EU_Leamer_Relative_Factor_Abundance.png")
